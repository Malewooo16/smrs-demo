  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex justify-center">
        <Link href={`/padmissions/activeSchools`}>
          {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {validatedAdmissions.length > 0
          ? validatedAdmissions.map((a: any) => (
              <div
                key={a.id}
                className="rounded-lg shadow-md border border-gray-200 p-6"
              >
                ...
                <p className="flex text-grey-500 font-semibold">
                  {" "}
                  Age: <AgeComponent dob={a.dob} />{" "}
                </p>

...
import AddStudentForm from '@/app/main-components/Students/AddStudentForm';
import { authOptions } from '@/utilities/authOptions';
import { getServerSession } from 'next-auth';
import React from 'react'

export default async function NewStudent({params}:{params:{classId:string}}) {
  ...
  return (
    <div>
        <h1 className='text-xl text-center my-4'>Add New Student to {classData?.name}</h1>
        <AddStudentForm/>
    </div>
  )
}

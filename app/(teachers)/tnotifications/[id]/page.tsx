...
import NotificationReader from '@/app/main-components/Notifications/NotificationReader';
import React from 'react'

export default async function SingleNotification({params}:{params:{id:string}}) {
        ...
        return(
           <div>
            ...
            <div className="text-sm text-gray-500 mb-2">
              <span>By: <span className="font-semibold text-gray-600">{createdBy?.name}</span></span>

import GroupInfo from "@/main-components/GroupInfo";
...
const parents = [{name: "rpickerell2", password: "msbaNPG0%~,lidrU+Xq<h="}];
    ...
    <div className="flex flex-col">
      ...
      <div className="flex justify-between max-w-5xl">
        ...
        <GroupInfo
          ...
          users={users}
          definition="Test School For SMRS"
        />
        <GroupInfo
          groupName="Parents"
          users={parents}
          definition="Test Parents For SMRS"
        />
      </div>
    </div>
  );

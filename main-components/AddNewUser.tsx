...
export default function AddNewUser( props : {nextStep:number , setNextStep:()=>void}) {
  ...
  <span> {error} </span>
    ...
    <FileUploadModal header="Testing" isOpen={introModal} onClose={() => setIntroModal(false)}>
          <div>
  ...
  <span> {`Files Uploaded Successfully`} </span>
          ...
          <form >
        <p className="text-xl my-4 text-center"> Your Workflow has been added! Upload Files related to this workflow </p>
